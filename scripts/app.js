  ...
  box.addEventListener(
    ...
    (e) => {
      ...
      if (clickCounter % 2 === 0) {
        ...
        h3.style.color = "#f94a00";
        target.style.color = "#00AFF9";
      } else {
        target.innerText = "O";
        turn.classList.remove("fa-o");
        turn.classList.add("fa-x");
        playerTwoChoices.push(Number(target.id));
        h3.style.color = "#00AFF9";
        target.style.color = "#f94a00";
      }
      clickCounter++;
      if (playerOneChoices.length >= 3 || playerTwoChoices.length >= 3) {
        if (checkForWinner(playerOneChoices)) {
          ...
          winnerText.innerText = "The winner is PLAYER 1!";
          winnerText.style.color = "#00AFF9";
          //playerOneScore++
          addPlayerOneScore();
          ...
          winnerDeclaration.classList.toggle("show-winner");
          winnerText.innerText = "The winner is PLAYER 2!";
          winnerText.style.color = "#f94a00";
          addPlayerTwoScore();
